...
fn part_2() {
    ...
    assert_eq!(total, 66681);
    println!("Answer: {total}");
}

const _INPUT: &str = "Game 1: 4 red, 1 green, 15 blue; 6 green, 2 red, 10 blue; 7 blue, 6 green, 4 red; 12 blue, 10 green, 3 red
